...
<div class="container tab" >  
  <form class="contact" id="before" action="form_without_submit.php" method="post" target="fname">
 ...
 <iframe name="fname" width="0" height="0" style="display: none;"></iframe>
...
function nextPrev(n) {
 ...
 var test=n;
  if(currentTab==test){
        document.getElementById("before").submit();
        test=1;
  }
  /*else if(currentTab==n){
      document.getElementById("before").addEventListener("submit",function(event){
