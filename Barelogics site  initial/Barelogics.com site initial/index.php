...
<head>
  <title>Barelogics-less is more</title>
  <meta charset="utf-8" />
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
	<meta name="description" content="Barelogic Solutions Pvt Limited is mobile app development company focused only upon one thing — quality app development services.We are expertise in iOS & Android Apps Development, IOT App Development, Augmented Reality & Virtual Reality App Development, Mobile Commerce, Wearable App Development, Blockchain Wallet apps development, ICOs and Cryptocurrency apps development, banking, finance.">
	<meta name="keywords" content="IOS,Android App,Android,Mobile development,barelogics,barelogic">
<link rel="icon" href="img/logo/Asset.svg" sizes="any" type="image/svg+xml">
	<link rel="icon" href="img/logo/logo.jpg" sizes="16x16 32x32" type="image/jpg">
  <!-- css -->
  ...
  <nav class="navbar navbar-default" role="navigation">
    <div class="container">
      <div class="navbar-header">
        ...
        <!-- Logo text or image -->
        <a class="navbar-brand" href="index.html">BareLogics</a>
  ...
  <div id="intro">
    <div class="intro-text">
      <div class="container">
        <div class="col-md-12">
          <div id="rotator">
            <h1><span class="1strotate">Barelogics, Less is more, Creativity and technology</span></h1>
            <div class="line-spacer"></div>
            <p><span class="2ndrotate">Mobile App Development, Brand Identity, Promotion</span></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
            ...
            <p>Focused only upon one thing — quality app development services.We’ve been building unique digital products, platforms.</p>
          </div>
        </div>
      </div>
      <div class="row wow fadeInUp">
        ...
        <div class="col-md-6 content">
          <h2>Barelogics is located at Hyderabad,in India developing mobile apps.</h2>
          <h3>The mobile app development wing of Barelogics has rendered app development services for industries like automobile, food, health care, finance, ecommerce and much more.</h3>
          <p>
           Emerging technologies have always remained an area of strength for Barelogics. Augmented Reality, Wearables, BLE 4.0, etc. Are some of the technologies where Barelogics is playing its strengths on a global scale.Expertise in Mobile App Development, iPhone & Android App Development, IOT App Development, Augmented Reality App Development, Mobile Commerce, Wearable App Development,WhatsApp Development, Multi Vendor Marketplace Solution & Vacation Rental & Booking Solution
      ...
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
            <h2>Services</h2>
            <div class="heading-line"></div>
            <p>Digital transformations.We offer mobile application development, augmented & virtual reality app development and enterprise mobility solutions for b2b and b2c customers worldwide. </p>
          </div>
        </div>
      </div>
      <div class="row">
            ...
            <div class="carousel-inner">
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-offset-1 col-md-6">
                    <div class="wow bounceInLeft">
                      ...
                      <p>Our Android application developers look to ensure that our clients' applications are as unique as can be, thereby separating them from the rest of the pack and giving their business a chance to stand out. With extensive experience in developing a variety of apps – from basic-location tracking ones to chat applications similar to WhatsApp – Barelogics's team of Android developers is capable of meeting any challenge head on.</p>
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-5">
                    <div class="screenshot wow bounceInRight">
                      <img src="img/screenshots/AndroidApp.jpg" class="img-responsive" alt="" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-offset-1 col-md-6">
                    <div class="wow bounceInLeft">
                      ...
                      <p>Designing applications for the iPhone is a different kettle of fish compared to its Android counterparts and we took cognizance of this from day one.Our team of developers aims to provide clients with iPhone applications that enable them to engage with their customers in a manner that is most conducive for success. From enterprise users to mass consumers, the iPhone applications that we've developed thus far have been used extensively and the feedback garnered has been extremely positive testament to Barelogics's quest for excellence..</p>
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-5">
                    <div class="screenshot wow bounceInRight">
              ...
              <div class="item">
                <div class="row">
                  <div class="col-sm-12 col-md-offset-1 col-md-6">
                    <div class="wow bounceInLeft">
                      <h4>Wearables App Development</h4>
                      <p>Being a android developer company with a future oriented vision, for us, a watch or a wrist band is not a mere accessory. It is piece of technology that needs to brought to the reach of common masses. That is why developing Android mobile apps for wearables has become to be one of our core competencies. We marked our entry into the wearable mobile app development industry with a healthcare app that is ranking high in app stores.</p>
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-5">
                    <div class="screenshot wow bounceInRight">
                      <img src="img/screenshots/Smartwatches.jpg" class="img-responsive" alt="" />
                    </div>
                  </div>
                </div>
              </div>
  ...
  <section id="parallax2" class="home-section parallax" data-stellar-background-ratio="0.5">
    <div class="container">
      <div class="row">
		    <div class="col-md-12">
          <div class="color-light">
            <h2 class="wow bounceInDown" data-wow-delay="0.5s">Contact Us</h2>
            <p class="lead wow bounceInUp" data-wow-delay="1s">Want to discuss and know more Contact Us!</p>
          </div>
        </div>      
      </div>
    </div>
...
-->
  ...
  <section id="contact" class="home-section bg-gray">
    <div class="container">
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
            <h2>Contact us</h2>
            <div class="heading-line"></div>
            <p>If you have any question to Barelogics  please fill out form below. </p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div id="sendmessage">Your message has been sent. Thank you! <?= $success ?></div>
          <div id="errormessage"></div>

          <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post" class="form-horizontal contactForm" role="form">
            <div class="col-md-offset-2 col-md-8">
            ...
            <div class="col-md-offset-2 col-md-8">
              <div class="form-group">
                <input type="number" class="form-control" name="phone" id="subject" placeholder="Mobile Number" data-rule="phone" data-msg="Please enter a valid number" />
                <div class="validation"></div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-md-offset-2 col-md-8">
                <button name="submit" type="submit" class="btn btn-theme btn-lg btn-block">Send message</button>
              </div>
            </div>
          </form>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="contact-widget wow bounceInLeft">
            ...
            <h5>Main Office</h5>
            <p>
              PLOT NO. 60, THIRD FLOOR, AYYAPPA SWAMY SOCIETY, MADHAPUR, HYDERABAD Hyderabad TG 500081 IN
            </p>
          </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
          <div class="contact-widget wow bounceInRight">
            ...
            <h5>Email us</h5>
            <p>
             contact@barelogics.com<br />info@barelogics.com
            </p>
          </div>
        </div>
      </div>
      <div class="row mar-top30">
        <div class="col-md-12">
          ...
          <ul class="social-network">
            ...
            <li><a href="https://www.linkedin.com/company/barelogics" target="_blank">
						<span class="fa-stack fa-2x">
							<i class="fa fa-circle fa-stack-2x"></i>
